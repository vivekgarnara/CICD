...
class TestPytestDemo:
    ...
    @allure.description("Verify the get users API returns status 200 and contains user list with IDs")
    ...
    @allure.description("Verify the get post API returns status 200 with correct post ID and title")
    @allure.severity("Critical")
    ...
    @allure.description("Verify the get posts API filters correctly by userId parameter and returns matching posts")
    @allure.severity("Critical")
